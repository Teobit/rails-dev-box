...
exec { 'install_ruby':
  ...
  command => "${as_vagrant} '${home}/.rvm/bin/rvm install 2.1.0 --latest-binary --autolibs=enabled && rvm --fuzzy alias create default 2.0.0'",
  creates => "${home}/.rvm/bin/ruby",
  require => Exec['install_rvm']
}

exec { "${as_vagrant} 'gem install bundler --no-rdoc --no-ri -v 1.5.1'":
